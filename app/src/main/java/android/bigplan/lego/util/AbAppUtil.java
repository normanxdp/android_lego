...
public class AbAppUtil {
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        try {
            ...
            int x = x = Integer.parseInt(field.get(obj).toString());
     ...
     * 双击返回键退出程序
     *
     * @param exitAppInterf 退出程序回调接口
     * @param minTimeMillis 退出程序的最小时间
     */
    public static void exitForDoubleBack(ExitAppInterf exitAppInterf, long minTimeMillis) {
        if (exitAppInterf == null) {
            return;
        }
        if (SystemClock.elapsedRealtime() - preTimeMillis < minTimeMillis) {
            exitAppInterf.exit();
        } else {
            preTimeMillis = SystemClock.elapsedRealtime();
            exitAppInterf.again();
        }
    }
