...
public class RechargeForOilCardLogActivity extends BaseTActivity implements AdapterView.OnItemClickListener, View.OnClickListener,SwipeRefreshLayout.OnRefreshListener {
    private final static String TAG = RechargeForOilCardLogActivity.class.getSimpleName();
    ...
    private void initView() {
        if (!TextUtils.isEmpty(mStrLogType)){
            ...
            switch (mStrLogType){
                ...
                case "10":
                    reason = getString(R.string.label_my_wallet_petrochina);
                    break;
                case "11":
                    reason = getString(R.string.label_my_wallet_sinopec);
                    break;
                default:
                    mStrLogType = "10";
                    reason = getString(R.string.label_my_wallet_petrochina);
