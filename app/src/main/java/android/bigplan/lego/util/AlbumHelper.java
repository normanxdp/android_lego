...
import android.bigplan.lego.model.ImageItem;
...
//		Uri selectedImage = data.getData();							//获取意图的参数		
//		String uriType = selectedImage.toString();								
//		String imagePath = "";
//		if(uriType.startsWith("content")){							//判断Uri类型是否为内容提供者
...
//			cursor.close();
//		}else if(uriType.startsWith("file")){						//判断Uri类型是否返回文件路径
//			imagePath = selectedImage.getPath();					//获取编码后的路径(中文路径可能被编码)
//			
//		}else{														//如果都不是,则提示
//			Toast.makeText(this, "请从相册或文件管理器中选择图片", Toast.LENGTH_LONG).show();
//			return "";
//		}		
//		
//		if(!imagePath.endsWith(".jpg") && !imagePath.endsWith(".png")){	//判断选择的图片格式是否为JPG或者PNG
//			Toast.makeText(this,"格式错误\n请选择jpg或png格式的图片", Toast.LENGTH_LONG).show();
//			return "";
//		}		
//		
//		return imagePath;												//返回文件的绝对路径
//	}
