 ...
 */
package android.bigplan.lego.db.storage;

import java.util.List;

import android.content.Context;
import android.bigplan.lego.db.orm.dao.AbDBDaoImpl;
import android.bigplan.lego.db.storage.AbSqliteStorageListener.AbDataDeleteListener;
import android.bigplan.lego.db.storage.AbSqliteStorageListener.AbDataInsertListListener;
import android.bigplan.lego.db.storage.AbSqliteStorageListener.AbDataInsertListener;
import android.bigplan.lego.db.storage.AbSqliteStorageListener.AbDataSelectListener;
import android.bigplan.lego.db.storage.AbSqliteStorageListener.AbDataUpdateListener;
import android.bigplan.lego.task.AbTaskItem;
import android.bigplan.lego.task.AbTaskListListener;
