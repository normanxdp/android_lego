...
public class PaySetPasswordView implements View.OnClickListener {
	...
	public PaySetPasswordView(String monney, Context mContext, OnPayListener listener){
		getDecorView(monney, mContext, listener);
	}
	public static PaySetPasswordView getInstance(String monney,Context mContext,OnPayListener listener){
		return  new PaySetPasswordView(monney,mContext,listener);
	}

	public void getDecorView(String monney,Context mContext,OnPayListener listener){
		this.listener=listener;
		this.mContext=mContext;
		mView= LayoutInflater.from(mContext).inflate(R.layout.item_setpaypassword, null);
		...
		if (!TextUtils.isEmpty(monney) && monney.equals("validate_password")){
			TextView title_right =(TextView)mView.findViewById(R.id.toolbar_title_right);
			if (title_right != null){
				title_right.setText(mContext.getString(R.string.pay_pwd_validates));
			}
		}
