...
public class HoloCircularProgressBar extends View {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (isThumbEnabled()) {
            ...
            canvas.drawCircle(mThumbPosX, mThumbPosY, 40, mHeadPaint);

            canvas.rotate(90 - progressRotation, mThumbPosX, 0);
            Rect targetRect = new Rect((int)mThumbPosX-10, (int) mThumbPosY-10, (int)mThumbPosX + 10, (int) mThumbPosY + 10);

            canvas.drawText(Integer.toString((int)(mProgress * mDuration)), targetRect.left, targetRect.bottom, mTextPaint);
            canvas.restore();
            ...
            canvas.rotate(90 - progressRotation, mTranslationOffsetX, 0);
         //   Log.d(TAG, "progress rotation: " + progressRotation + " x: " + Float.toString(mThumbPosX)
         //   + "  y: " + Float.toString(mThumbPosY));
    ...
    private void updateProgressColor() {
        ...
        mHeadPaint.setColor(Color.YELLOW);
      //  mHeadPaint.setStyle(Paint.Style.STROKE);
        mHeadPaint.setStrokeWidth(3);
