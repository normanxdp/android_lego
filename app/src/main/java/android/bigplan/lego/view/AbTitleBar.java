...
import android.bigplan.lego.util.AbViewUtil;
...
public class AbTitleBar extends LinearLayout{
    ...
    /** 标题栏布局ID. */
    public final static int mAbTitleBarID = 1;
    ...
    public void ininTitleBar(Context context) {
        ...
        titleTextBtn.setTextColor(getResources().getColor(R.color.black));
...
//        logoView.setBackgroundResource(R.drawable.line);
        ...
        this.addView(leftLayout, rightViewLayoutParams);
       ...
       // setTitleBarBackgroundColor(Color.rgb(6, 132, 255));
    ...
    /**
     * 描述：设置标题文字对齐方式 根据右边的具体情况判定方向： （1）中间靠近 Gravity.CENTER,Gravity.CENTER （2）左边居左 右边居右Gravity.LEFT,Gravity.RIGHT
     * （3）左边居中，右边居右Gravity.CENTER,Gravity.RIGHT （4）左边居右，右边居右Gravity.RIGHT,Gravity.RIGHT 必须在addRightView(view)方法后设置
     * 
...
//        View leftBtn = mInflater.inflate(R.layout.top_left_back, null);
//        leftLayout.setVisibility(View.VISIBLE);
//        leftLayout.addView(leftBtn, layoutParamsFF);
    }
...
//        leftLayout.addView(leftBtn, layoutParamsFF);
    ...
    public void showWindow(View parent, View view, boolean offsetMode) {
        ...
        popupWindow.setBackgroundDrawable(
                new ColorDrawable(Resources.getSystem().getColor(android.R.color.transparent)));
