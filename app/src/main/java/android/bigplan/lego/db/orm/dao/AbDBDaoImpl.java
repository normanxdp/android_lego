 ...
 */
package android.bigplan.lego.db.orm.dao;
...
import android.bigplan.lego.db.AbBasicDBDao;
import android.bigplan.lego.db.orm.AbTableHelper;
import android.bigplan.lego.db.orm.annotation.ActionType;
import android.bigplan.lego.db.orm.annotation.Column;
import android.bigplan.lego.db.orm.annotation.Id;
import android.bigplan.lego.db.orm.annotation.Relations;
import android.bigplan.lego.db.orm.annotation.RelationsType;
...
public class AbDBDaoImpl<T> extends AbBasicDBDao implements AbDBDao<T> {
	...
	public T queryOne(String column,String value) {
		synchronized (lock) {
