...
public class PayPwdActivity extends BaseTActivity implements View.OnClickListener {
    ...
    protected String getToolBarTitle(){
        return  getString(R.string.pay_pwd_success);
    }
    ...
    protected View getDecorViewDialog() {
        ...
        return PaySetPasswordView.getInstance("", this, new PaySetPasswordView.OnPayListener() {
    ...
    protected void onSuccessCallback(String url, String content, JSONObject param){
        try {
            if (url.equals("/Wallet/ModidyPassword")){
                AbToastUtil.showToast(mContext,"密码设置成功");
                AppApplication.getInstance().getUser().setPayPwd("lego_pay_pwd");
    ...
    private void setPayData(String pass) {
        ...
        post("/Wallet/ModidyPassword", object);
    }
}
