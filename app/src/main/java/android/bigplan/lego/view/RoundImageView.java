...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray types = this.mContext.obtainStyledAttributes(attrs, R.styleable.RoundImageView);

		mBorderThickness = types.getDimensionPixelSize(R.styleable.RoundImageView_border_thickness, DEFAUTL_BORDER_THICKNESS);
		mBorderInsideThickness = types.getDimensionPixelSize(R.styleable.RoundImageView_border_inside_thickness, DEFAUTL_BORDER_THICKNESS);
		mBorderOutsideThickness = types.getDimensionPixelSize(R.styleable.RoundImageView_border_outside_thickness, DEFAUTL_BORDER_THICKNESS);
		...
		mBorderColor = types.getColor(R.styleable.RoundImageView_border_color, DEFAULT_COLOR);
		mBorderInsideColor = types.getColor(R.styleable.RoundImageView_border_inside_color, DEFAULT_COLOR);
		mBorderOutsideColor = types.getColor(R.styleable.RoundImageView_border_outside_color, DEFAULT_COLOR);
...
//			Bitmap backgroundRoundBitmap = getBackgroundRoundBitmap(bitmap, radius);
			Bitmap roundBitmap = getCroppedRoundBitmap(bitmap, radius);
//			canvas.drawBitmap(backgroundRoundBitmap, mDefaultWidth / 2f - radius, mDefaultHeight / 2f - radius, null);
	 ...
	 * @return
	 */
	private Bitmap getBackgroundRoundBitmap(Bitmap bmp, int radius) {
		Bitmap scaledSrcBmp;
		...
		paint.setColor(Color.parseColor("#0094ff"));
